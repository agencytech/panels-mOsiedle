        ...
        <div class="relative h-screen isolate overflow-hidden bg-black">
            <div class="h-screen flex items-center w-full justify-center">
                <div class="flex flex-col items-center">
                    <h2 id="clock" class="text-7xl font-bold tracking-tight sm:text-9xl font-[poppins]">00:00</h2>
                    <!-- <p class="mx-auto mt-1 max-w-xl text-3xl text-gray-300">Czwartek</p> -->
                </div>
            </div>
            <svg viewBox="0 0 1024 1024" class="md:scale-100 scale-[50%] absolute left-1/2 md:top-[25%] -top-[0vh] -z-10 h-[64rem] w-[64rem] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)]" aria-hidden="true">
