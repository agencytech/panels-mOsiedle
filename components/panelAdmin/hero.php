        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
          <li>
            <ul role="list" class="-mx-2 space-y-1">
              <li>
                <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                <a id="nav_button" onclick="openPanelSite('ogloszenia')" class="cursor-pointer ogloszenia text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('docs')" class="cursor-pointer docs text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('uchwaly')" class="cursor-pointer uchwaly text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
                  <svg class=" h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('finanse')" class="cursor-pointer finanse text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
                  <svg class=" h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z" />
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('wspolnota')" class="cursor-pointer wspolnota text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
                  <svg class=" h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('history')" class="cursor-pointer history text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('support')" class="cursor-pointer support text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150">
...
<script>
    ...
    const url = "components/panelAdmin/" + site + ".php";
    fetch(url)
