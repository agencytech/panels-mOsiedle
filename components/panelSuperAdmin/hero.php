...
<div>
  ...
  <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
    ...
    <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
      <div class="flex h-16 shrink-0 items-center">
        <img class="h-8 w-auto" src="public/img/logo_long_superadmin.svg" alt="Your Company">
      </div>
      <nav class="flex flex-1 flex-col">
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
          <li>
            <ul role="list" class="-mx-2 space-y-1">
              <li>
                <a id="nav_button" onclick="openPanelSite('users')" class="cursor-pointer users text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('wspolnoty')" class="cursor-pointer wspolnoty text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
                  <svg class=" h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('changeLog')" class="cursor-pointer changeLog text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150">
