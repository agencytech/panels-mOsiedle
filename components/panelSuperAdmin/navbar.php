        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
          <li>
            <ul role="list" class="-mx-2 space-y-1">
              <li>
                <a id="nav_button" onclick="openPanelSite('users')" class="cursor-pointer users text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-xl active:scale-95 px-4 p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('mTablice')" class="active:scale-95 cursor-pointer mTablice text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-xl px-4 p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('wspolnoty')" class="cursor-pointer wspolnoty text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-xl active:scale-95 px-4 p-2 text-sm leading-6 font-semibold duration-150">
                  <svg class=" h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <li>
                ...
                <a id="nav_button" onclick="openPanelSite('ogloszenia')" class="cursor-pointer ogloszenia text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-xl active:scale-95 px-4 p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('docs')" class="cursor-pointer docs text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-xl active:scale-95 px-4 p-2 text-sm leading-6 font-semibold duration-150">
                  <svg class="h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('history')" class="cursor-pointer history text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-xl active:scale-95 px-4 p-2 text-sm leading-6 font-semibold duration-150">
              ...
              <li>
                <a id="nav_button" onclick="openPanelSite('changeLog')" class="cursor-pointer changeLog text-gray-700 hover:bg-gray-100 group hover:text-gray-600 flex gap-x-3 rounded-xl active:scale-95 px-4 p-2 text-sm leading-6 font-semibold duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-600 duration-150">
          ...
          <li class="-mx-6 mt-auto flex items-center">
            ...
            <a id="nav_button" onclick="openPanelSite('my_account')" class="my_account w-[75%] flex items-center active:scale-95 gap-x-4 px-6 py-3 text-sm font-medium leading-6 text-gray-900  hover:bg-gray-200 duration-150 cursor-pointer">
            ...
            <a href="scripts/login/logout.php" class="w-[25%] h-full active:scale-95 flex items-center justify-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900  hover:bg-gray-200 duration-150 cursor-pointer">
