      ...
      <div class="inline-block min-w-full py-2 align-middle">
        ...
        <table class="w-full">
            ...
            $page_id = 1;
                ...
                $sql = "SELECT logs.id, users.fullName, users.fullName, logs.when, logs.object_id, logs.object_type, log_types.type,logs.description FROM `logs` left join users on users.id=logs.user_id join log_types on log_types.id=logs.type order by id desc limit 20 offset ".($page_id - 1) * 20;
