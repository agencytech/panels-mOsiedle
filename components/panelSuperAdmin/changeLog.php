<section data-aos="fade-in" data-aos-delay="100" class="">
    <div class="flex md:flex-row flex-col justify-between items-center w-full">
        <div>
            <h1 class="text-lg font-bold">Change log</h1>
            <p class="mt-2 text-sm text-gray-500">Dziennik zmian w systemie mOsiedle dla konkretnych wersji oprogramowania.</p>
        </div>
    </div>
    ...
    <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full py-2 align-middle mt-24">
        <div class="text-center">
            ...
            <h3 class="mt-2 text-sm font-semibold text-gray-900">Brak modułu</h3>
